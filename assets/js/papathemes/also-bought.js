            ...
            $.ajax({
                ...
                success: (resp) => {
                    ...
                    resp.data.site.products.edges.forEach(({ node }) => {
                        ...
                        const qty = node.minPurchaseQuantity || 0;
                        ...
                        const priceRangeHtml = priceRange ? Mustache.render(this.priceRangeTemplate, {
                            ...
                            nonSalePrice,
                            taxLabelHtml,
                            retailPriceRangeHtml: this.showRetailPrice ? retailPriceRangeHtml : '',
                            retailPriceHtml: this.showRetailPrice ? retailPriceHtml : '',
                        }, null, this.templateCustomTags) : '';
