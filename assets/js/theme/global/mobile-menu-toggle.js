...
export class MobileMenuToggle {
    ...
    show() {
        ...
        // this.$menu.siblings().children().children().not(this.$toggle).prop('inert', true);
    ...
    hide() {
        ...
        // this.$menu.siblings().children().children().not(this.$toggle).prop('inert', false);
        _.delay(() => {
            this.$body.children().not('header, .modal').prop('inert', false);
            this.$menu.prop('inert', false);
            $('.navPage-childList-item', this.$menu).children().prop('inert', false);
            $('.navPages-all-mobile', this.$menu).children().prop('inert', false);
            $('.navPage-subMenu-list', this.$menu).children().children().prop('inert', false);
            $('._titleSubmenu', this.$menu).children().prop('inert', false);
            $('.navPage-childList-item > .navPages-action-toggle', this.$menu).parent().siblings().prop('inert', false);
        }, 400);
